...
<<dendro1, fig=TRUE, width=4, height=3, include=FALSE>>=
...
\begin{center}
{
\includegraphics[width=4in, height=3in]{ggcluster-dendro1}
}
\end{center}
...
<<dendro2, fig=TRUE, width=4, height=3, include=FALSE>>=
p <- p + coord_flip() +
  opts(
...
\begin{center}
{
\includegraphics[width=4in, height=3in]{ggcluster-dendro2}
}
\end{center}
